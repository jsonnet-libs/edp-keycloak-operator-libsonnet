---
permalink: /1.15.0/v1/v1alpha1/keycloak/
---

# v1.v1alpha1.keycloak
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withInstallMainRealm(installMainRealm)`](#fn-specwithinstallmainrealm)
...
### fn spec.withInstallMainRealm

```ts
withInstallMainRealm(installMainRealm)
```
