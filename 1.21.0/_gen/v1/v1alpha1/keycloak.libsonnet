{
  ...
  spec: {
    '#users':: d.obj(help='"Users is a list of keycloak users"'),
    users: {
    ...
    '#withInstallMainRealm':: d.fn(help='', args=[d.arg(name='installMainRealm', type=d.T.boolean)]),
    withInstallMainRealm(installMainRealm): { spec+: { installMainRealm: installMainRealm } },
    '#withRealmName':: d.fn(help='', args=[d.arg(name='realmName', type=d.T.string)]),
    withRealmName(realmName): { spec+: { realmName: realmName } },
    '#withSecret':: d.fn(help='"Secret is the name of the k8s object Secret related to keycloak"', args=[d.arg(name='secret', type=d.T.string)]),
