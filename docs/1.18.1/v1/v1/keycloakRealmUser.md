---
permalink: /1.18.1/v1/v1/keycloakRealmUser/
---

# v1.v1.keycloakRealmUser
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withEmailVerified(emailVerified)`](#fn-specwithemailverified)
  * [`fn withEnabled(enabled)`](#fn-specwithenabled)
  * [`fn withFirstName(firstName)`](#fn-specwithfirstname)
  * [`fn withGroups(groups)`](#fn-specwithgroups)
  * [`fn withGroupsMixin(groups)`](#fn-specwithgroupsmixin)
  * [`fn withKeepResource(keepResource)`](#fn-specwithkeepresource)
  * [`fn withLastName(lastName)`](#fn-specwithlastname)
  ...
  * [`fn withRequiredUserActions(requiredUserActions)`](#fn-specwithrequireduseractions)
  * [`fn withRequiredUserActionsMixin(requiredUserActions)`](#fn-specwithrequireduseractionsmixin)
  ...
  * [`obj spec.passwordSecret`](#obj-specpasswordsecret)
    * [`fn withKey(key)`](#fn-specpasswordsecretwithkey)
...
new returns an instance of KeycloakRealmUser
...
### fn spec.withRequiredUserActions

```ts
withRequiredUserActions(requiredUserActions)
```
...
### fn spec.withRequiredUserActionsMixin

```ts
withRequiredUserActionsMixin(requiredUserActions)
```
...
### fn spec.passwordSecret.withKey
